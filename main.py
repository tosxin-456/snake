...
SPEED = 100
SPACE_SIZE = 50
SNAKE_COLORS = ['red', 'blue', 'green', 'yellow', 'purple']
FOOD_COLORS = ['pink', 'orange', 'cyan', 'magenta', 'lime']
...
def next_turn(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        canvas.delete("food")
        food = Food()
        change_colors()  # Change colors when food is eaten
    else:
...
def restart_game():
    global snake, food, score, direction, SNAKE_COLOR, FOOD_COLOR
    score = 0
    direction = 'down'
...
def change_colors():
    ...
    canvas.itemconfig("food", fill=FOOD_COLOR)
